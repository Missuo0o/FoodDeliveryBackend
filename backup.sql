...
/*!40000 ALTER TABLE `dish`
    DISABLE KEYS */;
INSERT INTO `dish`
VALUES (71, 'shrimp', 12, 0.01, 'https://missuo0o.oss-us-west-1.aliyuncs.com/a3f890da-b30c-4d87-860a-132ac994b022.jpeg',
        'test', 1, '2024-01-29 00:14:31', '2024-02-03 03:25:34', 1, 1),
       (72, 'rice1', 12, 0.01, 'https://missuo0o.oss-us-west-1.aliyuncs.com/a3f890da-b30c-4d87-860a-132ac994b022.jpeg',
        '', 1, '2024-01-29 21:24:31', '2024-02-03 04:04:28', 1, 1);
/*!40000 ALTER TABLE `dish`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 'admin', 'admin', '$1$ShunZhan$lrbh.EeHLA9Yyw.jsShZS0', '9299950764', 1, '1111', 1, '2022-02-15 15:51:20',
       ...
       (68, 'missuo', 'missuo', '$1$ShunZhan$lrbh.EeHLA9Yyw.jsShZS0', '9299950764', 1, '123456789', 1,
        '2024-02-01 18:01:15', '2024-02-09 00:23:26', 1, 1);
/*!40000 ALTER TABLE `employee`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
    ...
    `consignee`               varchar(12) COLLATE utf8mb3_bin                       NOT NULL,
    `cancel_reason`           varchar(50) COLLATE utf8mb3_bin                                DEFAULT NULL,
    `rejection_reason`        varchar(50) COLLATE utf8mb3_bin                                DEFAULT NULL,
...
-- Dump completed on 2024-02-09  6:15:08
